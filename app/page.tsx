...
const faqs = [
  ["How does Esgria calculate ESG scores?", "Esgria maps questionnaire answers and evidence to your ESG framework, weights the criteria, and applies AI-assisted checks before publishing a supplier score."],
  ...
  ["Does Esgria support CSRD?", "Esgria supports CSRD-aligned supplier data collection and can map custom questions to EU reporting requirements."],
  ["Does Esgria integrate with SAP?", "Professional and Enterprise plans support ERP integrations including SAP workflows through API and managed connectors."],
  ...
  ["How are corrective actions tracked?", "Esgria Tasks assigns owners, deadlines, reminders and status history for each supplier improvement plan."],
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:px-8">
        <a href="#top" className="flex items-center gap-3" aria-label="Esgria home">
          <span className="relative grid h-11 w-11 place-items-center overflow-hidden rounded-2xl border border-teal-100 bg-white shadow-hairline">
            <Image
              src="/esgria-logo.svg"
              alt="Esgria logo"
              width={44}
          ...
          <span className="text-lg font-semibold text-slate-950">Esgria</span>
        </a>
          ...
          <div className="flex flex-col gap-4 border-b border-slate-200 bg-alternate p-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-slate-500">Esgria Sp. z o.o. · Warsaw, Poland</div>
              </div>
            </div>
...
function TestimonialsAndFaq() {
  const testimonials = [
    ["Anna Kowalska", "Head of Sustainable Procurement", "Baltic Manufacturing", "Esgria reduced supplier ESG collection time from weeks to days. We finally have one trusted source of supplier sustainability data."],
      ...
      <section id="demo" className="bg-white px-5 py-20 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 rounded-[32px] bg-slate-950 p-8 text-white lg:grid-cols-[1fr_420px] lg:p-12">
          <div>
            ...
            <h2 className="max-w-2xl text-4xl font-semibold sm:text-5xl">See how Esgria turns supplier ESG chaos into verified intelligence.</h2>
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
              Esgria Sp. z o.o. · ul. Prosta 20, 00-850 Warsaw, Poland · hello@esgria.io
            </p>
          </div>
